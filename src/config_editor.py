        ...
        try:
            cfg = {
                ...
                "detector": {
                    ...
                    "glare_suppression": bool(data.get("glare_suppression", True)),
                    "glare_threshold": int(data.get("glare_threshold", 240)),
                ...
                "audio_filter": {
                    "enabled": bool(data.get("audio_filter_enabled", True)),
                    "window_sec": float(data.get("audio_window_sec", 0.5)),
                    "calibration_files": int(data.get("audio_calibration_files", 10)),
                    "sigma_factor": float(data.get("audio_sigma_factor", 2.0)),
                    "segment_padding": float(data.get("audio_segment_padding", 2.5)),
                    "trust_on_low_visibility": bool(data.get("audio_trust_low_visibility", True)),
                    "min_energy_db": float(data.get("audio_min_energy_db", -60.0)),
                    "night_min_energy_db": float(data.get("audio_night_min_energy_db", -70.0)),
                    "night_start_hour": int(data.get("audio_night_start_hour", 22)),
                    "night_end_hour": int(data.get("audio_night_end_hour", 6)),
                    "calibration_hour_start": int(data.get("audio_calibration_hour_start", 2)),
                    "calibration_hour_end": int(data.get("audio_calibration_hour_end", 5)),
                },
                "night_detection": {
                    "enabled": bool(data.get("night_detection_enabled", True)),
                    "brightness_threshold": int(data.get("night_brightness_threshold", 40)),
                    "twilight_threshold": int(data.get("night_twilight_threshold", 55)),
                    "roi_metering": bool(data.get("night_roi_metering", True)),
                    "glare_twilight_fraction": float(data.get("glare_twilight_fraction", 0.10)),
                    "sample_fps": float(data.get("night_sample_fps", 5)),
                    "flash_sigma": float(data.get("night_flash_sigma", 2.5)),
                    "min_flash_sep_sec": float(data.get("night_min_flash_sep_sec", 1.0)),
                    "merge_window_sec": float(data.get("night_merge_window_sec", 4.0)),
                },
                "location": {
